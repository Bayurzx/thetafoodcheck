                ...
                <div className="md:flex no-wrap md:-mx-2">
                    ...
                    <div className="w-full md:w-3/12 md:mx-2">
                        ...
                        <div className="bg-white dark:bg-gray-900 p-3 border-t-4 border-green-400">
                            ...
                            <h1 className="text-gray-900 dark:text-gray-200 font-bold text-xl leading-8 my-1">Jane Doe</h1>
                            <h3 className="text-gray-600 dark:text-gray-300 font-lg text-bold leading-6">Owner at Her Company Inc.</h3>
                    ...
                    <div className="w-full md:w-9/12 mx-2 h-64">
                        ...
                        <div className="bg-white dark:bg-gray-900 p-3 shadow-sm rounded-sm">
                                ...
                                <div className="grid md:grid-cols-2 text-sm">
                                    ...
                                    <div className="grid grid-cols-2">
                                        ...
                                        <div className="px-4 py-2">
                                            <a className="text-blue-800 dark:text-blue-400" href="mailto:jane@example.com">jane@example.com</a>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2">
                            ...
                            <button className="block w-full text-blue-800 dark:text-blue-400 text-sm font-bold rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:shadow-outline focus:bg-gray-100 dark:focus:bg-gray-700 hover:shadow-xs p-3 my-4">
